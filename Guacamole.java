...
/**
 * Guacamole is a type of condiment on a burrito, this class describes that.
 * 
 * @author Cody Moffitt
 * @version 1.0
 */
public class Guacamole extends BurritoCondiment
{

    /**
     * Constructor for objects of class Guacamole, attaches it to a BurritoFiller.
     * @param         BurritoFiller upperLayer
     */
    public Guacamole(BurritoFiller upperLayer)
    {
        super(upperLayer); //Attach this as the lowest layer so far in the BurritoItems
    }
     /**
     * Overloaded constructor for objects of class Guacamole, attaches it to a BurritoCondiment.
     * @param         BurritoCondiment upperLayer
     */
    public Guacamole(BurritoCondiment upperLayer)
    {
        super(upperLayer); //Attach this as the lowest layer so far in the BurritoItems
    }
